...
Perhatian: Projek ini kemungkinan akan memasuki mode setengah perawatan
(jadi kebanyakan penyempurnaan kode backend dan perbaikan minor).
...
## Fitur
- `📈️ Memoisasi` (teknik caching yang mempercepat pencarian pada area yang tidak selalu berubah).
- `📈️ Pencarian memori terbatas` (hanya cari di beberapa area memori (perhatian: mungkin tidak bisa bekerja dengan baik di beberapa perangkat)
...
- Pb2 v2.106.11 (build 170, tidak kompatibel)
- Pb2 v2.106.12 (build 171, belum diuji)
- GameGuardian v101.0
- Android 7-14
- Root (menggunakan region Other)
- vPhoneGaGa (menggunakan region Other)

Skrip ini FOSS (Perangkat lunak Gratis dan bersumber-terbuka) di GitHub, dan sebentar lagi mungkin Codeberg/Bitbucket
...
- AGH - Value Tembus dinding & hp kendaraan GG.
- Pumpkin Hacker - tembus dinding, big body, pohon berwarna, item flamethower besar, bayangan.
